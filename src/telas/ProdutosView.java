...
String[] colunas={"Nome", "Custo unitário","Descrição"};
  public void att(){
...
custo,
    ...
    private void initComponents() {
        ...
        editarprodbtn.setText("Editar produto");
    ...
    private void editarprodbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarprodbtnActionPerformed
      ...
      if(tabela.isRowSelected(i)){
        edicaoProdutos ep=new edicaoProdutos();
ep.setVisible(true);
    ep.getrow(setrow());
